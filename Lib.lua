...
function library:Watermark(text)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(211, 117, 80)
...
function library:Introduction()
    ...
    xsxLogo.ImageColor3 = Color3.fromRGB(211, 117, 80)
    ...
    hashLogo.ImageColor3 = Color3.fromRGB(211, 117, 80)
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(211, 117, 80)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(211, 117, 80)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(211, 117, 80)}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(211, 117, 80)}):Play()
            end)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(211,  127, 94)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(106, 69, 181))}
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(211, 117, 80)}):Play()
                end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            for i,v in next, list do
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(211, 117, 80)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(211, 117, 80)}):Play()
